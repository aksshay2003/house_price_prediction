...
#it is univariate because it takes only single feature
...
class NumericalUnivariateAnalysis(UnivariateAnalysisStrategy):
    def analyze(self, df: pd.DataFrame, feature: str):
        ...
        sns.histplot(df[feature], kde=True, bins=30) #kde=kernel density estimate(adds line to the histogram) bins=no. of intervals
